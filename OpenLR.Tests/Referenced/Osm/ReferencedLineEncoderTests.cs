...
namespace OpenLR.Tests.Referenced.Osm
{
    ...
    public class ReferencedLineEncoderTests
    {
        ...
        {            
            ...
            Assert.AreEqual(0, referencedLocation.PositivePercentageOffset);
        ...
        /// </remarks>
        [Test]
        public void EncodeLineLocation2BuildLineLocationInvalidStartWithOffset()
        {
            // build a graph to encode from.
            var tags = new TagsTableCollectionIndex();
            var graphDataSource = new DynamicGraphRouterDataSource<LiveEdge>(tags);
            ...
            Assert.AreEqual(edge.Forward, referencedLocation.Edges[1].Forward);
            Assert.AreEqual(edge.Tags, referencedLocation.Edges[1].Tags);
            Assert.AreEqual(60, referencedLocation.PositivePercentageOffset, 1);
            Assert.AreEqual(0, referencedLocation.NegativePercentageOffset);
        }
        ...
        /// </remarks>
        [Test]
        public void EncodeLineLocation3BuildLineLocationInvalidEndWithOffset()
        {
            // build a graph to encode from.
            var tags = new TagsTableCollectionIndex();
            var graphDataSource = new DynamicGraphRouterDataSource<LiveEdge>(tags);
            ...
            Assert.AreEqual(edge.Tags, referencedLocation.Edges[1].Tags);
            Assert.AreEqual(0, referencedLocation.PositivePercentageOffset, 1);
            Assert.AreEqual(60, referencedLocation.NegativePercentageOffset, 1);
        }
    }
}
