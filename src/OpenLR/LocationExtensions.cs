...
//         /// </summary>
//         /// <returns></returns>
//         public static List<(double longitude, double latitude, float? e)> GetCoordinates(this ReferencedLine route, Coder coder, float offsetRatio,
...
//             if (route.Edges == null || route.Edges.Length == 0) { throw new ArgumentOutOfRangeException(nameof(route), "Route has no edges."); }
//             if (route.Vertices == null || route.Vertices.Length == 0) { throw new ArgumentOutOfRangeException(nameof(route), "Route has no vertices."); }
//             if (route.Vertices.Length != route.Edges.Length + 1) { throw new ArgumentOutOfRangeException(nameof(route), "Route is invalid: there should be n vertices and n-1 edges."); }
//
