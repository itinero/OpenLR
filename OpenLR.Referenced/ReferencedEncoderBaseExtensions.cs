...
namespace OpenLR.Referenced
{
    ...
    public static class ReferencedEncoderBaseExtensions
    {
        ...
        public static ReferencedPointAlongLine BuildPointAlongLine(this ReferencedEncoderBase encoder, GeoCoordinate location, Meter maxDistance, double boxSize = 0.1)
        {
            ...
            referencedLine.PositiveOffset = 0;
            referencedLine.NegativeOffset = 0;
            ...
            GeoCoordinate endLocation1, GeoCoordinate endLocation2, Meter endOffset, Meter tolerance)
        {
            ...
            {
                negativeOffset = (float)edgeLength.Value;
            }
            ...
            { // forward edge.
                negativeOffset = (float)endOffset.Value;
            }
            ...
            { // backward edge.
                negativeOffset = (float)(edgeLength.Value - endOffset.Value);
            }
            else 
            {
            ...
            return encoder.BuildLineLocation(vertices.ToArray(), edges.ToArray(), positiveOffset, negativeOffset);
        }
        ...
        /// <param name="positiveOffset">The offset in percentage relative to the distance of the total path and it's start. [0-100[</param>
        /// <param name="negativeOffset">The offset in percentage relative to the distance of the total path and it's end. [0-100[</param>
        /// <returns></returns>
        public static ReferencedLine BuildLineLocation(this ReferencedEncoderBase encoder, long[] vertices, LiveEdge[] edges,
            float positiveOffset, float negativeOffset)
        {
            // validate parameters.
            ...
            referencedLine.NegativeOffset = negativeOffset;
            referencedLine.PositiveOffset = positiveOffset;
