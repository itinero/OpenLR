...
namespace OpenLR.OsmSharp.Decoding
{
        ...
        where TEdge : IDynamicGraphEdgeData
    {
        ...
        public ReferencedRectangleDecoder(OpenLR.Decoding.LocationDecoder<RectangleLocation> rawDecoder, IBasicRouterDataSource<TEdge> graph, IBasicRouter<TEdge> router)
